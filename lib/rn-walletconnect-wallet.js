(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("rn-walletconnect-wallet", ["crypto"], factory);
	else if(typeof exports === 'object')
		exports["rn-walletconnect-wallet"] = factory(require("crypto"));
	else
		root["rn-walletconnect-wallet"] = factory(root["crypto"]);
...
var _jsWalletconnectCore = __webpack_require__(2);
...
var WalletConnector = function (_Connector) {
  _inherits(WalletConnector, _Connector);

  function WalletConnector() {
    _classCallCheck(this, WalletConnector);

    return _possibleConstructorReturn(this, (WalletConnector.__proto__ || Object.getPrototypeOf(WalletConnector)).apply(this, arguments));
  }

  _createClass(WalletConnector, [{
    key: 'sendSessionStatus',
    ...
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        ...
        var fcmToken, walletWebhook, _sessionData$data, data, verifiedData, encryptedData, res;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                fcmToken = sessionData.fcmToken, walletWebhook = sessionData.walletWebhook, _sessionData$data = sessionData.data, data = _sessionData$data === undefined ? {} : _sessionData$data;
              ...
              case 3:
                ...
                if (Array.isArray(data)) {
                  data.map(function (address) {
                    _this2.validateEthereumAddress(address) ? verifiedData = data : console.log('Invalid eth address');
                  });
                } else if (typeof data === 'string') {
                  verifiedData = data.split().map(function (address) {
                    _this2.validateEthereumAddress(address) ? verifiedData = data.split() : console.log('Invalid eth address');
                  });
                }

                // encrypt data
                _context.next = 7;
                return this.encrypt(verifiedData);

              case 7:
                encryptedData = _context.sent;
                _context.next = 10;
                return fetch(this.bridgeURL + '/session/' + this.sessionId, {
                  method: 'PUT',
                  headers: {
    ...
    key: 'sendTransactionStatus',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(transactionId) {
        var statusData = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        var encryptedData, res;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                _context2.next = 4;
                return this.encrypt(statusData);

              case 4:
                encryptedData = _context2.sent;
                _context2.next = 7;
                return fetch(this.bridgeURL + '/session/' + this.sessionId + '/transaction/' + transactionId + '/status/new', {
                  method: 'POST',
                  headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json'
      ...
      function sendTransactionStatus(_x3) {
    ...
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(transactionId) {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                return _context3.abrupt('return', this._getEncryptedData('/session/' + this.sessionId + '/transaction/' + transactionId));
      ...
      function getTransactionRequest(_x4) {
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                return _context4.abrupt('return', /^(0x){1}[0-9a-fA-F]{40}$/i.test(address));
      ...
      function validateEthereumAddress(_x5) {
        return _ref4.apply(this, arguments);
      }

      return validateEthereumAddress;
    }()
  }]);
...
//# sourceMappingURL=rn-walletconnect-wallet.js.map