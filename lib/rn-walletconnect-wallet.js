            ...
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                if (Array.isArray(data)) {
                  data.forEach(function (address) {
                    if (_this2.validateEthereumAddress(address)) {
                  ...
                  data.split().forEach(function (address) {
                    if (_this2.validateEthereumAddress(address)) {
                      verifiedData.push(address);
                    } else {
                      throw new Error('Invalid ethereum address');
              ...
              case 7:
                ...
                return fetch(this.bridgeURL + '/session/' + this.sessionId, {
                  ...
                  body: JSON.stringify({ fcmToken: fcmToken, walletWebhook: walletWebhook, data: encryptedData })
                });
